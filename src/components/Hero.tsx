...
const HomeHero = ({
  ...
  const structuredData = {
    ...
    description:
      "Building farmer managed seed system community of practice (COP) for a Resilient East Africa Region. A landmark gathering championing seed sovereignty and strengthening farmer-managed seed systems.",
    ...
    keywords:
      "indigenous seeds, seed sovereignty, farmer-managed seed systems, Eastern Africa agriculture, climate resilience, agricultural biodiversity, community seed banks",
    sameAs: [
      "https://twitter.com/EAISC2026",
      "https://linkedin.com/company/eaisc2026",
    ],
  ...
  const webpageData = {
    ...
    description:
      "Join the premier conference on indigenous seed systems in Eastern Africa. Connect with farmers, researchers, and policymakers championing seed sovereignty.",
    url: "https://eaindigenousseedsconference.org",
...
, Kenya from November 17-20, 2026."
        ...
        <meta
          property="og:image"
          content="https://eaindigenousseedsconference.org/images/og-image.jpg"
        />
        <meta property="og:image:width" content="1200" />
        <meta property="og:image:height" content="630" />
        <meta
          property="og:image:alt"
          content="1st Eastern Africa Indigenous Seed Conference 2026 banner"
        />
...
, Kenya from November 17-20, 2026."
        ...
        <meta
          name="twitter:image"
          content="https://eaindigenousseedsconference.org/images/twitter-card.jpg"
        />
        <meta
          name="twitter:image:alt"
          content="EA-ISC 2026 Conference Banner"
        />
        ...
        <link
          rel="alternate"
          hrefLang="en"
          href="https://eaindigenousseedsconference.org"
        />
        <link
          rel="alternate"
          hrefLang="sw"
          href="https://eaindigenousseedsconference.org/sw"
        />
        <link
          rel="alternate"
          hrefLang="x-default"
      ...
      >
        ...
        <div className="home-hero-container">
          <div className="home-hero-content">
            ...
            <h2
              className="home-hero-title-highlight"
              aria-label="EAISC 2026 - Eastern Africa Indigenous Seed Conference 2026"
            >
              EA-ISC 2026
            </h2>

            <p className="home-hero-theme" itemProp="description">
              Building farmer managed seed system community of practice (COP)
              For a Resilient EASTERN AFRICA Region.
            </p>

            <div className="home-hero-meta" aria-label="Event details">
              <div className="home-meta-item">
                <span className="home-meta-icon" aria-hidden="true">
                  📅
                </span>
