...
const RegistrationPage = () => {
  ...
  const registrationStructuredData = {
    ...
    description:
      "Register for the premier conference on seed sovereignty in Eastern Africa. Choose from delegate, farmer, or virtual participation options. Submit your abstract for consideration.",
    url: "https://eaindigenousseedsconference.org/registration-abstract",
    mainEntity: {
      "@type": "Event",
      name: "1st Eastern Africa Indigenous Seed Conference 2026",
      description:
        "A landmark gathering championing seed sovereignty and strengthening farmer-managed seed systems across Eastern Africa.",
  ...
  const callForPapersData = {
    ...
    description:
      "Submit your research, case studies, and experiences on indigenous seed systems, seed sovereignty, and farmer-managed agriculture for presentation at the conference.",
    ...
    keywords:
      "call for papers, abstract submission, indigenous seeds research, seed sovereignty papers, agricultural research, Eastern Africa studies",
  };
  ...
  return (
    <>
      <Helmet>
        {/* Primary Meta Tags */}
        <title>
          Registration & Abstract Submission | EA-ISC 2026 | Eastern Africa
          Indigenous Seed Conference
        </title>
        <meta
          name="description"
          content="Register for the 1st Eastern Africa Indigenous Seed Conference 2026. Choose from delegate, farmer, or virtual participation options. Submit your abstract for consideration. Early bird discounts available until October 31, 2026."
        />
        <meta
          name="keywords"
          content="conference registration, abstract submission, seed conference registration, Eastern Africa conference, farmer registration, delegate fees, call for papers, indigenous seeds research, Nairobi conference 2026, seed sovereignty conference"
        />
        ...
        <link
          rel="canonical"
          href="https://eaindigenousseedsconference.org/registration-abstract"
        />
        ...
        <meta
          property="og:url"
          content="https://eaindigenousseedsconference.org/registration-abstract"
        />
        <meta
          property="og:title"
          content="Registration & Abstract Submission | EA-ISC 2026"
        />
        <meta
          property="og:description"
          content="Secure your place at the premier conference on seed sovereignty in Eastern Africa. Register now or submit your abstract for consideration. Early bird discounts available."
        />
        <meta
          property="og:image"
          content="https://eaindigenousseedsconference.org/images/registration-og-image.jpg"
        />
        <meta property="og:image:width" content="1200" />
        <meta property="og:image:height" content="630" />
        <meta
          property="og:image:alt"
          content="Registration for Eastern Africa Indigenous Seed Conference 2026"
        />
        ...
        <meta
          ...
          content="Register for the 1st Eastern Africa Indigenous Seed Conference. Choose your participation type and submit your abstract. Early bird ends October 31, 2026."
        />
        <meta
          name="twitter:image"
          content="https://eaindigenousseedsconference.org/images/registration-twitter-card.jpg"
        />
        <meta
          name="twitter:image:alt"
          content="Registration for Eastern Africa Indigenous Seed Conference"
        />
      ...
      <div className="reg-page" itemScope itemType="https://schema.org/WebPage">
        <meta
          itemProp="name"
          content="Registration & Abstract Submission - 1st Eastern Africa Indigenous Seed Conference 2026"
        />
        <meta
          itemProp="description"
          content="Register for the premier conference on seed sovereignty in Eastern Africa. Choose your participation type and submit your abstract."
        />

        {/* Hero Section with Background Image */}
        <section
          className="reg-page-hero"
        ...
        >
          ...
          <div className="reg-page-hero-container">
            ...
            <div className="reg-page-hero-content">
              <span
                className="reg-page-hero-tag"
                aria-label="Registration page"
              >
                Registration
              </span>
              <h1 className="reg-page-hero-title" itemProp="headline">
                Join Us at the 1st Eastern Africa Indigenous Seed Conference
                2026
              </h1>
              <p className="reg-page-hero-subtitle" itemProp="description">
                Secure your place at the region's premier gathering on seed
                sovereignty and farmer-managed seed systems.
              </p>
        ...
        <div
          className="reg-section-wrapper paper-texture"
        ...
        <div
          className="abstract-section-wrapper pattern-dots"
          itemProp="mainContentOfPage"
        >
          <AbstractSubmission />
        </div>
        ...
        >
          ...
          >
            <meta
              itemProp="name"
              content="International Delegate Registration"
            />
            <meta itemProp="price" content="400" />
            <meta itemProp="priceCurrency" content="USD" />
            <meta
              itemProp="description"
              content="Full conference access for international delegates"
            />
          </div>
          <div
            itemProp="itemListElement"
          ...
          >
            ...
            <meta
              itemProp="description"
              content="Full conference access for African delegates"
            />
          </div>
          <div
            itemProp="itemListElement"
          ...
          >
            ...
            <meta
              itemProp="description"
              content="Full conference access with farmer-focused workshops and field visits"
            />
          </div>
          <div
            itemProp="itemListElement"
          ...
          >
            ...
            <meta
              itemProp="description"
              content="Live streaming access, digital materials, and virtual networking"
            />
          </div>
        </div>
        ...
        >
          ...
          >
            ...
            <meta
              itemProp="description"
              content="August 15, 2026 - Submit your research on indigenous seed systems"
            />
          </div>
          <div
            itemProp="itemListElement"
          ...
          >
            ...
            <meta
              itemProp="description"
              content="September 15, 2026 - Authors notified of acceptance decisions"
            />
          </div>
          <div
            itemProp="itemListElement"
          ...
          >
            ...
            <meta
              itemProp="description"
              content="300 words maximum, excluding references"
            />
          </div>
        </div>
      </div>
